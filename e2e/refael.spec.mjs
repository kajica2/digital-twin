...
//   local    → ${BASE}/pages/refael-mp4-maker.html  (server runs --directory .,
...
//   PORT=5180 node refael.spec.mjs     # python3 -m http.server 5180 --directory .
...
const REFAEL_URL = `${BASE}/pages/refael-mp4-maker.html`;
