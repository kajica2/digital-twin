...
//   - Extract metadata from .mp3 (ID3v2.3 / ID3v2.4), .wav (RIFF fmt +
//     LIST/INFO sub-chunks), and .aif/.aiff (FORM/AIFF + COMM/NAME/AUTH/
//     ANNO/ID3 chunks). Sample-rate math for AIFF uses 80-bit IEEE 754
//     extended precision (big-endian).
